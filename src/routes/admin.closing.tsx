  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        <Stat label="Pending" value={money(t.pending)} tone={t.pending > 0 ? "danger" : "success"} />
      ...
      <div className="grid gap-3 lg:grid-cols-2">
        {state.salesmen.map((sm) => {
          const att = state.attendance.find((a) => a.salesmanId === sm.id && a.date === state.today);
          ...
          return (
            <Card key={sm.id}>
              ...
              <Btn
                ...
                onClick={() =>
                  confirm("Close salesman day?", `${sm.name}'s day will be marked closed.`, () => closeDay(sm.id), "Close")
                }
              >
